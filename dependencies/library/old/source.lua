...
local library = {
    ...
    themes = {
        ...
        Lavender = {
            ["Accent"] = fromRGB(113, 93, 133),
            ["Window Background"] = fromRGB(40, 40, 40),
            ["Window Border"] = fromRGB(70, 70, 70),
            ["Black Border"] = fromRGB(15, 15, 15),
            ["Text"] = fromRGB(220, 220, 220),
            ["Disabled Text"] = fromRGB(130, 130, 130),
            ["Tab Background"] = fromRGB(30, 30, 30),
            ["Tab Border"] = fromRGB(50, 50, 50),
            ["Section Background"] = fromRGB(30, 30, 30),
            ["Section Border"] = fromRGB(60, 60, 60),
            ["Object Background"] = fromRGB(25, 25, 25),
            ["Object Border"] = fromRGB(45, 45, 45),
            ["Dropdown Option Background"] = fromRGB(18, 18, 18)
        },
        
        Dark = {
            ["Accent"] = fromRGB(113, 93, 133),
            ["Window Background"] = fromRGB(30, 30, 30),
            ["Window Border"] = fromRGB(60, 60, 60),
            ["Black Border"] = fromRGB(10, 10, 10),
            ["Text"] = fromRGB(220, 220, 220),
            ["Disabled Text"] = fromRGB(120, 120, 120),
            ["Tab Background"] = fromRGB(28, 28, 28),
            ["Tab Border"] = fromRGB(48, 48, 48),
            ["Section Background"] = fromRGB(30, 30, 30),
            ["Section Border"] = fromRGB(60, 60, 60),
            ["Object Background"] = fromRGB(25, 25, 25),
            ["Object Border"] = fromRGB(50, 50, 50),
            ["Dropdown Option Background"] = fromRGB(18, 18, 18)
        },

        Candy = {
            ["Accent"] = fromRGB(255, 105, 180),
            ["Window Background"] = fromRGB(50, 30, 50),
            ["Window Border"] = fromRGB(80, 50, 80),
            ["Black Border"] = fromRGB(30, 10, 30),
            ["Text"] = fromRGB(255, 200, 255),
            ["Disabled Text"] = fromRGB(150, 100, 150),
            ["Tab Background"] = fromRGB(60, 40, 60),
            ["Tab Border"] = fromRGB(90, 60, 90),
            ["Section Background"] = fromRGB(55, 35, 55),
            ["Section Border"] = fromRGB(85, 55, 85),
            ["Object Background"] = fromRGB(50, 30, 50),
            ["Object Border"] = fromRGB(80, 50, 80),
            ["Dropdown Option Background"] = fromRGB(45, 25, 45)
        },

        Midnight = {
            ["Accent"] = fromRGB(75, 0, 130),
            ["Window Background"] = fromRGB(15, 15, 30),
            ["Window Border"] = fromRGB(30, 30, 60),
            ["Black Border"] = fromRGB(10, 10, 20),
            ["Text"] = fromRGB(200, 200, 255),
            ["Disabled Text"] = fromRGB(100, 100, 150),
            ["Tab Background"] = fromRGB(20, 20, 40),
            ["Tab Border"] = fromRGB(40, 40, 80),
            ["Section Background"] = fromRGB(25, 25, 50),
            ["Section Border"] = fromRGB(50, 50, 100),
            ["Object Background"] = fromRGB(20, 20, 40),
            ["Object Border"] = fromRGB(40, 40, 80),
            ["Dropdown Option Background"] = fromRGB(15, 15, 30)
        },

        Forest = {
            ["Accent"] = fromRGB(34, 139, 34),
            ["Window Background"] = fromRGB(20, 30, 20),
            ["Window Border"] = fromRGB(40, 60, 40),
            ["Black Border"] = fromRGB(10, 20, 10),
            ["Text"] = fromRGB(200, 220, 200),
            ["Disabled Text"] = fromRGB(100, 120, 100),
            ["Tab Background"] = fromRGB(25, 35, 25),
            ["Tab Border"] = fromRGB(50, 70, 50),
            ["Section Background"] = fromRGB(30, 40, 30),
            ["Section Border"] = fromRGB(60, 80, 60),
            ["Object Background"] = fromRGB(25, 35, 25),
            ["Object Border"] = fromRGB(50, 70, 50),
            ["Dropdown Option Background"] = fromRGB(20, 30, 20)
        },

        Sunset = {
            ["Accent"] = fromRGB(255, 94, 77),
            ["Window Background"] = fromRGB(40, 30, 30),
            ["Window Border"] = fromRGB(70, 50, 50),
            ["Black Border"] = fromRGB(20, 10, 10),
            ["Text"] = fromRGB(255, 220, 200),
            ["Disabled Text"] = fromRGB(150, 120, 100),
            ["Tab Background"] = fromRGB(50, 40, 40),
            ["Tab Border"] = fromRGB(80, 60, 60),
            ["Section Background"] = fromRGB(45, 35, 35),
            ["Section Border"] = fromRGB(75, 55, 55),
            ["Object Background"] = fromRGB(40, 30, 30),
            ["Object Border"] = fromRGB(70, 50, 50),
            ["Dropdown Option Background"] = fromRGB(35, 25, 25)
        },

        Ocean = {
            ["Accent"] = fromRGB(0, 123, 167),
            ["Window Background"] = fromRGB(20, 30, 40),
            ["Window Border"] = fromRGB(30, 50, 70),
            ["Black Border"] = fromRGB(10, 20, 30),
            ["Text"] = fromRGB(200, 220, 240),
            ["Disabled Text"] = fromRGB(100, 120, 140),
            ["Tab Background"] = fromRGB(25, 35, 45),
            ["Tab Border"] = fromRGB(40, 60, 80),
            ["Section Background"] = fromRGB(30, 40, 50),
            ["Section Border"] = fromRGB(50, 70, 90),
            ["Object Background"] = fromRGB(25, 35, 45),
            ["Object Border"] = fromRGB(40, 60, 80),
            ["Dropdown Option Background"] = fromRGB(20, 30, 40)
        }
    }
}
    ...
    local function set(key)
        ...
        if key and enums[key] and (keys[key] or services.UserInputService:GetStringForKeyCode(key) ~= "") then
            ...
            if not options.listignored then
                ...
                if library.keybind_list:Exists(holder.name) and key_str then
